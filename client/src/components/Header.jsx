...
export function Header({ isConnected, reconnecting, demoStartTime, onStartDemo, onResetDemo, teamView, setTeamView }) {
  ...
  return (
    <header className="bg-white border-b border-gray-200 sticky top-0 z-40 shadow-sm">
      <div className="max-w-7xl mx-auto px-8 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="px-4 py-2.5 bg-purple-600 text-white rounded-lg text-sm font-semibold hover:bg-purple-700 transition-all flex items-center gap-2"
          >
      ...
      {showBrief && <ExecutiveBriefModal onClose={() => setShowBrief(false)} />}
    </header>
  );
}
